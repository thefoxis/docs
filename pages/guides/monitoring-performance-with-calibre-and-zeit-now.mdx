...
export const meta = {
  ...
  lastEdited: '2020-02-17T00:30:35.000Z'
}
...
To deploy your project with a [ZEIT Now for Git Integration](/docs/v2/git-integrations), make sure your created project has been pushed to a Git repository.
